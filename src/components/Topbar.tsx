...
<div className="flex items-center gap-3 mt-2 sm:mt-0">
  <a
    ...
    className="p-2 rounded-full text-white 
               bg-gradient-to-br from-[#0D47A1] to-[#1976D2]
  ...
  <a
    href="#"
    className="p-2 rounded-full text-white 
               bg-gradient-to-br from-gray-700/40 to-black/70
               bg-[length:200%_200%] bg-left-top 
               hover:bg-right-bottom
               transition-all duration-500
               hover:scale-110
  ...
  <a
    href="#"
    className="p-2 rounded-full text-white 
               bg-gradient-to-br from-[#004182] to-[#0A66C2]
               bg-[length:200%_200%] bg-left-top 
               hover:bg-right-bottom
               transition-all duration-500
               hover:scale-110
  ...
  <a
    href="#"
    className="p-2 rounded-full text-white 
               bg-gradient-to-br from-[#C13584] via-[#833AB4] to-[#FCAF45]
               bg-[length:200%_200%] bg-left-top 
               hover:bg-right-bottom
               transition-all duration-500
               hover:scale-110
